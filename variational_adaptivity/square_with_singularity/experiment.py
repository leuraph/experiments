...
where an explicit expression for the analytic solution u is unavailable.
However, the energy norm may be represented as an
eigenfunction expansion and yields that [1]

|| u ||_a^2 = || nabla u ||_L2^2 = 0.035144253738788451...

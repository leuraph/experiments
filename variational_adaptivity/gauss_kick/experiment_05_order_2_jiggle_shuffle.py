...
def main() -> None:
    ...
    base_results_path = Path('results/experiment_05') / Path(f'theta_{THETA}')
    ...
    delta = 1./2**(ExperimentConfig.N_INITIAL_REFINEMENTS)
    ...
    # NOTE we shuffle after jiggle to get the same jiggle for
    # both experiment 4 and 5 (same seed)
